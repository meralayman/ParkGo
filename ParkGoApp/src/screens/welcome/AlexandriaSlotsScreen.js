...
export function AlexandriaSlotsScreen({ navigation }) {
  ...
  return (
    <LandingBackground>
      ...
      <Screen transparent scroll contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <Text style={{ color: Colors.text, fontSize: 24, fontWeight: '900', marginBottom: 6 }}>{LOT_NAME}</Text>
        <Text style={{ color: Colors.muted, fontSize: 15, marginBottom: 16 }}>Pick an available slot to continue booking.</Text>
